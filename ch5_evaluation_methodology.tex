...
\textbf{Interval Coverage} \quad This metrics is measure for nominal levels, \(\alpha \in \{0.01,0.05,0.5,0.75,0.99\}\). Once defined the nominal level investigated the empirical coverage is:
\[
