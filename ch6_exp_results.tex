...
In this experiments we distinguish between training and valuation windows, since the latter are fully held out, according to what described in Sec.\ref{sec:sliding_window_ch4}.
