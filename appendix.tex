...
this rule fails when $x$ is driven by a Brownian motion. It\^{o}'s Lemma provides the correct generalisation.
...
It\^{o} correction. It is absent in ordinary calculus and arises
...
\]
Applying It\^{o}'s product rule we get:
\[
    (dX_t)^2 = b_t^2\, dt.
\]
...
\]
which rearranges to Eq.~(\ref{eq:ito_lemma}).
