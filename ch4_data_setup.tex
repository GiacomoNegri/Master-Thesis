...
constraints imposed by MIG partitioning of the A100 GPU by the university's High-Performance Computing policy. The full memory analysis is given in App.~\ref{app:sec:attention_memory}.
