...
\begin{itemize}
    ...
    \item \textbf{Phase 2, EDM-CSDI:} window length \(L = 512\) and stride \(s = 100\), yielding \(25,226\) maximum possible windows with no validation \(\texttt{val\_split\_ratio}=0\).
\end{itemize}
