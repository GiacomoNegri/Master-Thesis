...
This section specified the dataset characteristics and training choices. A summary table is made available at Tab.\ref{tab:training_setup}, where single-valued row are parameters shared across both Phase~1 and Phase~2. 
\section{Data}
