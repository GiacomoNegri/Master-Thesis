...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.33\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/Transformer_architecture.png}
    \caption{Transformer model architecture. Source: Vaswani et al.\ \cite{vaswani2017attention}.}
