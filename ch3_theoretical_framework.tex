...
The models are both feeded OHLC quantities already in log-space, and specifically the overnight return and the intraday range, because it is a better conditioning than log-transformed variables. Moreover, both models are fitted independently
per ticker by maximum likelihood using L-BFGS-B [REFERENCE], making them ticket specific.
