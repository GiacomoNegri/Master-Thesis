...
$C_{\tau+k} = \sum_{j=1}^{\tau+k} r_j$ 
is motivated by the GBM theoretical derivation of Sec.~\ref{sec:gbm_sde_ch2} and by the experimental results shown in Figures~4--6 of \cite{kim2025diffusion}, that otherwise wouldn't have any reason to differentiate VE with GBM.
